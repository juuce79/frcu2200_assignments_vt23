...
/**
 * HeavyAttack is a non-magical ability that targets a single enemy.
...
public class HeavyAttack extends BaseAbility {
    /**
     * The constructor for the HeavyAttack ability which sets the cost in action points and energy to use the ability.
     */
    public HeavyAttack() {
